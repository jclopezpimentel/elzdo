    ...
    <section class="content">
            <div align="center" id="alert">
                ...
                if ($flag != null){
                    switch ($flag) {
                        case "0":
                            echo "<div id='alerta' class='alert-danger'>Formato de canción invalido</div>";
                            break;
                        case "1":
                        ...
                        case "2":
                            ...
                            break;
                        case "3":
                            echo '<div id="alerta" class="alert-danger">Error al cargar los Archivos</div>';
                            break;
                        default:
                            break;
                    }
        ...
        <div id="adminSD">
            <form enctype="multipart/form-data" action="crearDisco" class="formoid-solid-blue" style="background-color:#FFFFFF;font-size:14px;font-family:'Roboto',Arial,Helvetica,sans-serif;color:#34495E;max-width:480px;min-width:150px" method="post"><div class="title"><h2>Crear disco</h2></div>
            <div class="element-input"><label class="title"><span class="required">*</span></label><div class="item-cont"><input class="large" type="text" name="disco" required="required" placeholder="Nombre de Disco"/><span class="icon-place"></span></div></div>
            <div class="element-input"><label class="title"><span class="required">*</span></label><div class="item-cont"><input class="large" type="text" name="autor" required="required" placeholder="Autor"/><span class="icon-place"></span></div></div>
            <div class="element-file"><label class="title"><span class="required">*</span></label><div class="item-cont"><label class="large" ><div class="button">Portada</div><input type="file" class="file_input" name="portada" required="required"/><div class="file_text">Ningun Archivo Seleccionado</div><span class="icon-place"></span></label></div></div>
            <div class="element-textarea"><label class="title"></label><div class="item-cont"><textarea class="medium" name="descripcion" cols="20" rows="5" placeholder="Descripción"></textarea><span class="icon-place"></span></div></div>
            <div class="element-select"><label class="title"><span class="required">*</span></label><div class="item-cont"><div class="large"><span>
                        ...
                        <option value="" disabled selected>Seleccione un grado Escolar</option>
                        <?php if(count($grados)>0){foreach ($grados as $key):?>
                            <option value="<?=$key['id']?>"><?=$key['nombre']?></option>
                        <?php endforeach;}?>
                        <option value="addG">+ Agregar nuevo grado escolar</option>
                    </select> 
            <i></i><span class="icon-place"></span></span></div></div></div>
            <div class="element-file"><label class="title"><span class="required">*</span></label><div class="item-cont"><label class="large" ><div class="button">Canción</div><input type="file" class="file_input" name="zipDisco" required="required"/><div class="file_text">Ningun Archivo Seleccionado</div><span class="icon-place"></span></label></div>
            <label class="title">Debe subir una canción para crear el disco</label>
            </div>
