...
<?php $this->load->view('SharedAdmin/header');?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
                ...
                if ($flag != null){
                    switch ($flag) {
                        ...
                        case "1":
                            ...
                            break;
                        case "2":
                            echo '<div id="alerta" class="alert-danger">Error al cargar el imagen</div>';
                            break;
                        default:
                            break;
                    }
        ...
        <div id="adminSD">
            <form enctype="multipart/form-data" action="editarDiscos" class="formoid-solid-blue" style="background-color:#FFFFFF;font-size:14px;font-family:'Roboto',Arial,Helvetica,sans-serif;color:#34495E;max-width:480px;min-width:150px" method="post"><div class="title"><h2>Disco</h2></div>
            <input type="hidden" name="id" required="required" value="<?=$id?>" />
            <div class="element-input"><label class="title"><span class="required">*</span></label><div class="item-cont"><input class="large" type="text" name="disco" required="required" placeholder="Nombre de Disco" value="<?=$nombreDisco?>" /><span class="icon-place"></span></div></div>
            <div class="element-input"><label class="title"><span class="required">*</span></label><div class="item-cont"><input class="large" type="text" name="autor" required="required" placeholder="Autor" value="<?=$autor?>" /><span class="icon-place"></span></div></div>
            <div class="element-file"><label class="title"><span class="required">*</span></label><div class="item-cont"><label class="large" ><div class="button">Portada</div><input type="file" class="file_input" name="portada" /><div class="file_text">Ningun Archivo Seleccionado</div><span class="icon-place"></span></label></div></div>
            <div class="element-textarea"><label class="title"></label><div class="item-cont"><textarea class="medium" name="descripcion" cols="20" rows="5" placeholder="Descripción"><?=$descripcion?></textarea><span class="icon-place"></span></div></div>
            <div class="element-select"><label class="title"><span class="required">*</span></label><div class="item-cont"><div class="large"><span>
                        ...
                        <?php if(count($disco)>0){foreach ($disco as $key):?>
            ...
            <div class="element-select"><label class="title"><span class="required">*</span></label><div class="item-cont"><div class="large"><span>
                    <select id="cancion" name="cancion" onchange="suprCancion(this.value)">
                        <option value="" selected disabled>Eliminar Canciones</option>
                        <?php if(count($canciones)>0){foreach ($canciones as $key):?>
