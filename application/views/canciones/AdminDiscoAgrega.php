            ...
            <div>
                ...
                ?>
                    ...
                    <div id="adminSD">
                        ...
                        <form name="form1" enctype="multipart/form-data" action="subircancion" class="formoid-solid-blue" style="background-color:#ffffff;font-size:14px;font-family:'Roboto',Arial,Helvetica,sans-serif;color:#12345e;max-width:480px;min-width:150px" method="post">
                <div class="title"><h2>Agregar Canciones a Disco</h2></div>
                ...
                <div class="element-select" title="Selecciona grado escolar"><label class="title"><span class="required">*</span></label><div class="item-cont"><div class="large"><span>
                    <select id="grado" name="disco" required="required" onchange="addG(this.value)" onchange="addG(this.value)">
                        <option value="" disabled selected>Seleccione un Disco</option>
                        <?php
                        if(count($grados)>0){ 
                            foreach ($grados as $grado):?>
                                    <option value="<?=$grado['id']?>"><?=$grado['nombreDisco']?></option>
                        <?php endforeach;}?>
                    </select><i></i><span class="icon-place"></span></span></div></div></div>
                <div class="element-file" ><label class="title"><span class="required">*</span></label><div class="item-cont"><label class="large" ><div class="button">Seleccionar Canción</div><input type="file" class="file_input" name="file" required="required"/><div class="file_text">No file selected</div><span class="icon-place"></span></label></div></div>
