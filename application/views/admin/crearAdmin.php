...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
            ...
            if ($flag != null){
                switch ($flag) {
                    ...
                    case "2":
                        ...
                        break;
                    case "0":
                        echo '<div id="alerta" class="alert-danger">Error al registrar usuario, intente nuevamente</div>';
                        break;
                    case "4":
                        echo '<div id="alerta" class="alert-danger">Error el correo ya esta registrado, intente nuevamente</div>';
                        break;
                    default:
                        break;
                }
        ...
        <div>
            <form enctype="multipart/form-data" action="registrarAdmin" name="crear" class="formoid-solid-blue" style="background-color:#FFFFFF;font-size:14px;font-family:'Roboto',Arial,Helvetica,sans-serif;color:#34495E;max-width:480px;min-width:150px" method="post" onsubmit="return validarFormAdmin()"><div class="title"><h2>Crear Administrador</h2></div>
                <div class="element-input"><label class="title"><span class="required">*</span></label><div class="item-cont"><input id="name" class="large" type="text" name="name" required="required" placeholder="Nombre Completo"/><span class="icon-place"></span></div></div>
                <!--<div class="element-email"><label class="title"><span class="required">*</span></label><div class="item-cont"><input id="correo" class="large" type="mail" name="correo" required="required" placeholder="Correo"/><span class="icon-place"></span></div></div>-->
                <div class="element-email"><label class="title"></label><div class="item-cont"><input class="large" id="correo" type="email" name="correo" value="" placeholder="Email"/><span class="icon-place"></span></div></div>
                <div class="element-password"><label class="title"><span class="required">*</span></label><div class="item-cont"><input class="large" type="password" id="contrasena" name="contrasena" value="" required="required" placeholder="Contraseña"/><span class="icon-place"></span></div></div>
                <div class="element-password"><label class="title"><span class="required">*</span></label><div class="item-cont"><input class="large" type="password" id="Ccontrasena" name="confirmContrasena" value="" required="required" placeholder="Confirmar Contraseña"/><span class="icon-place"></span></div></div>
                <div class="element-file"><label class="title"></label><div class="item-cont"><label class="large" ><div class="button">Foto</div><input type="file" class="file_input" name="foto" required/><div class="file_text">Ningún Archivo Seleccionado</div><span class="icon-place"></span></label></div></div>
                <div class="element-select"><label class="title"><span class="required">*</span></label><div class="item-cont"><div class="large"><span><select id="tipo" name="tipo" required="required" onchange="selectPrivilegios(this.value)">
                                    <option value="" disabled selected>Seleccione una opción</option>
                        <option value="Recursos">Recursos</option>
                        <option value="General">General</option></select><i></i><span class="icon-place"></span></span></div></div></div>
                <div class="element-textarea"><label class="title"></label><div class="item-cont"><textarea class="medium" id="descripcion" name="descripcion" cols="20" rows="5" placeholder="Descripción"></textarea><span class="icon-place"></span></div></div>
                <div class="element-checkbox"><label class="title">Privilegios<span class="required">*</span></label>		<div class="column column1"><label><input type="checkbox" name="sd" value="Secuencias Didacticas"><span>Secuencias Didacticas</span></label><label><input type="checkbox" name="ed" value="Educación y Derecho" ><span>Educación y Derecho</span></label><label><input type="checkbox" name="pr" value="Promo Radio" ><span>Promo Radio</span></label><label><input type="checkbox" name="ac" value="Audio Cuentos" ><span>Audio Cuentos</span></label><label><input type="checkbox" name="cn" value="Canciones" ><span>Canciones</span></label><label><input type="checkbox" name="vd" value="Videos" ><span>Videos</span></label><label><input type="checkbox" name="lb" value="Libros" ><span>Libros</span></label></div><span class="clearfix"></span>
                </div>
