...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
        <div align="center" id="alert">
            ...
            if ($flag != null){
                switch ($flag) {
                    case "0":
                        echo "<div id='alerta' class='alert-danger'>Error al actualizar</div>";
        ...
        <div>
        <form action="updatePrivilegios" class="formoid-solid-blue" style="background-color:#FFFFFF;font-size:14px;font-family:'Roboto',Arial,Helvetica,sans-serif;color:#34495E;max-width:480px;min-width:150px" method="post"><div class="title"><h2>Actualizar Privilegios</h2></div>
	<div class="element-select"><label class="title"><span class="required">*</span></label><div class="item-cont"><div class="large"><span>
                        <select name="admin" required="required" onchange="getPrivilegios(this.value)">
	...
	<div class="element-checkbox"><label class="title">Checkboxes</label>		<div class="column column1"><label>
                    <input type="checkbox" name="sd" id="sd" value="Secuencias didácticas">
                               <span>Secuencias didácticas</span></label><label><input type="checkbox" id="ed" name="ed" value="Educación y derechos">
                               <span>Educación y derechos</span></label><label><input type="checkbox" id="pr" name="pr" value="Promo Radio">
                               <span>Promo Radio</span></label><label><input type="checkbox" name="ac" id="ac" value="Audio Cuentos">
                               <span>Audio Cuentos</span></label><label><input type="checkbox" name="cn" id="cn" value="Canciones">
                               <span>Canciones</span></label><label><input type="checkbox" name="vd" id="vd" value="Videos">
                               <span>Videos</span></label><label><input type="checkbox" name="lb" id="lb" value="Libros">
                               <span>Libros</span></label></div><span class="clearfix"></span>
        </div>
