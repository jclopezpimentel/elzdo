...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
        ...
        <form enctype="multipart/form-data" class="formoid-solid-blue" style="background-color:#FFFFFF;font-size:14px;font-family:'Roboto',Arial,Helvetica,sans-serif;color:#34495E;max-width:480px;min-width:150px" method="post" action="editarLibros"><div class="title"><h2>Libro</h2></div>
        <input type="hidden" name="id" required="required" value="<?=$id?>" />
                    ...
                    <input class="large" type="text" name="titulo" required="required" placeholder="Titulo" value="<?=$titulo?>" /><span class="icon-place"></span></div></div>
                    ...
                    <input type="file" class="file_input" name="image" /><div class="file_text">Imagen del Libro</div><span class="icon-place"></span></label></div></div>
                    ...
                    <input type="file" class="file_input" name="libro" /><div class="file_text">Nuevo Libro</div><span class="icon-place"></span></label></div></div>
                    <div class="element-textarea" title="Descripcion"><label class="title"><span class="required">*</span></label><div class="item-cont">

                    <textarea class="medium" name="descrip" cols="20" rows="5" required="required" placeholder="Descripcion"><?=$descripcion?></textarea><span class="icon-place"></span></div></div>
