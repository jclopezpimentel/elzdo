    ...
    <section class="content">
        <div class="container">
            ...
            <div>
                ...
                <div>
                    <form enctype="multipart/form-data" action="AddPodcats" class="formoid-solid-blue" style="background-color:#FFFFFF;font-size:14px;font-family:'Roboto',Arial,Helvetica,sans-serif;color:#34495E;max-width:480px;min-width:150px" method="post"><div class="title"><h2>Subir Podcast</h2></div>
	<div class="element-input"><label class="title"><span class="required">*</span></label><div class="item-cont"><input class="large" type="text" name="titulo" required="required" placeholder="Titulo"/><span class="icon-place"></span></div></div>
	<div class="element-file"><label class="title"><span class="required">*</span></label><div class="item-cont"><label class="large" ><div class="button">Podcast</div><input type="file" class="file_input" name="podcast" required="required"/><div class="file_text">Ningun archivo seleccionado</div><span class="icon-place"></span></label></div></div>
	<div class="element-textarea"><label class="title"><span class="required">*</span></label><div class="item-cont"><textarea class="medium" name="descripcion" cols="20" rows="5" required="required" placeholder="Descripcion"></textarea><span class="icon-place"></span></div></div>
