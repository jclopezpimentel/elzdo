...
//                                                            for ($i=0;$i<5;$i=$i+1){
                                                ...
                                                foreach($tabla as $podcast){
							echo "<tr>";
                                                                echo "<td class='idd hidden'>".$podcast['id']."</td>";
								echo "<td>".$podcast['titulo']."</td>";
                                                                echo "<td>".$podcast['descripcion']."</td>";
								echo "<td>".$podcast['fechar']."</td>";
								echo "<td>";
									echo "<button class='btn btn-primary'><a style='color:white;text-decoration:none' target='_blank' href='".$podcast['podcast']."'>Abrir</a></button>";
                  echo "<button class='btn btn-primary'><a style='color:white;text-decoration:none' href='editaPodcast?id=".$podcast['id']."'>Editar</a></button>";
									echo "<input class='eliminarPodcast btn btn-primary' type='button' value='Eliminar'>";
                                                                        echo "<input class='hidden' value ='".$podcast['podcast']."' id='route".$podcast['id']."'>";
								echo "</td>";
							echo "</tr>";
						}
             }else{
