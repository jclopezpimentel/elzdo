...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="container">
			<div align="center"><h1>Secuencias didacticas</h1></div>
...
//                                                            for ($i=0;$i<5;$i=$i+1){
                                                ...
                                                foreach($tabla as $sd){
							echo "<tr>";
                                                                echo "<td class='idd hidden'>".$sd['id']."</td>";
                                                                echo "<td><img src='".$sd['portada']."' class='img-sm'></td>";
								echo "<td>".$sd['titulo']."</td>";
                                                                echo "<td>".$sd['nombre']."</td>";
								echo "<td>".$sd['fecha']."</td>";
								echo "<td>";
									echo "<button class='btn btn-primary'><a style='color:white;text-decoration:none' target='_blank' href='".$sd['pdf']."'>Abrir PDF</a></button>";
                  echo "<button class='btn btn-primary'><a style='color:white;text-decoration:none' href='editaSD?id=".$sd['id']."'>Editar</a></button>";
									echo "<input class='eliminarSD btn btn-primary' type='button' value='Eliminar'>";
                                                                        echo "<input class='hidden' value ='".$sd['portada']."' id='img".$sd['id']."'>";
                                                                        echo "<input class='hidden' value ='".$sd['pdf']."' id='pdf".$sd['id']."'>";
                                                                        echo "<input class='hidden' value ='".$sd['titulo']."' id='folder".$sd['id']."'>";
								echo "</td>";
							echo "</tr>";
						}
