...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
                ...
                if ($flag != null){
                    switch ($flag) {
                        ...
                        case "1":
                            ...
                            break;
                        case "2":
                            echo '<div id="alerta" class="alert-danger">Error al cargar el Pdf</div>';
                            break;
                        case "3":
                            echo '<div id="alerta" class="alert-danger">Error al cargar la imagen</div>';
                            break;
                        default:
                            break;
                    }
        ...
        <div id="adminSD">
            <form enctype="multipart/form-data" action="editarSecuencia" enctype="multipart/form-data" class="formoid-solid-blue" style="background-color:#FFFFFF;font-size:14px;font-family:'Roboto',Arial,Helvetica,sans-serif;color:#34495E;max-width:480px;min-width:150px" method="post">
                ...
                <input class="large" type="text" name="titulo" required placeholder="Titulo" value="<?=$titulo?>" /><span class="icon-place"></span></div></div>
                <div class="element-select"><label class="title"><span class="required">*</span></label><div class="item-cont"><div class="large"><span>
                                <select id="grado" name="gradoEscolar" required="required" onchange="addG(this.value)">
                                    ...
                                    foreach ($grade as $grades):?>
                                                    <option value="<?=$grades['id']?>"><?=$grades['nombre']?></option>
                                    <?php endforeach;}?>
                                ...
                                </select><i></i><span class="icon-place"></span></span></div></div><br>
                                </div>
                              <div class="element-file"><label class="title"><span class="required">*</span></label><div class="item-cont"><label class="large" ><div class="button">Portada</div><input type="file" class="file_input" name="imagen" accept="image/jpeg,image/png" /><div class="file_text">No file selected</div><span class="icon-place"></span></label></div></div>
                        <div class="element-file"><label class="title"><span class="required">*</span></label><div class="item-cont"><label class="large" ><div class="button">Pdf</div><input type="file" class="file_input" name="pdf" accept="application/pdf" /><div class="file_text">No file selected</div><span class="icon-place"></span></label></div>
                        <br><label>Modifique los campos que gusta actualizar</label>
                        </div>
