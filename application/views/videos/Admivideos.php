    ...
    <section class="content">
            <div align="center" id="alert">
                ...
                if ($flag != null){
                    switch ($flag) {
                        case "0":
                            echo "<div id='alerta' class='alert-danger'>Error al guardar los datos, intente nuevamente</div>";
...
//                ?>
        ...
        <div id="adminV">
            <form action="uploadvideos" enctype="multipart/form-data" class="formoid-solid-blue" style="background-color:#FFFFFF;font-size:14px;font-family:'Roboto',Arial,Helvetica,sans-serif;color:#34495E;max-width:480px;min-width:150px" method="post"><div class="title"><h2>Administrador de Videos</h2></div>
                <div class="element-input"><label class="title"></label><div class="item-cont"><input class="large" type="text" name="title" placeholder="Titulo" required/><span class="icon-place"></span></div></div>
                <div class="element-input"><label class="title"></label><div class="item-cont"><input class="large" type="text" name="url" placeholder="Ej: https://www.youtube.com/embed/Oa6NPqcWbiY" required/><span class="icon-place"></span></div></div>
