...
//                                                            for ($i=0;$i<5;$i=$i+1){
                                                ...
                                                foreach($tabla as $video){
							echo "<tr>";
                                                                echo "<td class='idd hidden'>".$video['id']."</td>";
								echo "<td>".$video['titulo']."</td>";
								echo "<td>".$video['fecha']."</td>";
								echo "<td>";
									echo "<button class='btn btn-primary'><a style='color:white;text-decoration:none' target='_blank' href='".$video['url']."'>Abrir</a></button>";
                  echo "<button class='btn btn-primary'><a style='color:white;text-decoration:none' href='editaVideo?id=".$video['id']."'>Editar</a></button>";
									echo "<input class='eliminarVideo btn btn-primary' type='button' value='Eliminar'>";
								echo "</td>";
							echo "</tr>";
						}
          }else{
