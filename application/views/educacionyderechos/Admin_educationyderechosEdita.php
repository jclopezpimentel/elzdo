...
<form action="editarDerechos"  enctype="multipart/form-data" class="formoid-solid-blue" style="background-color:#FFFFFF;font-size:14px;font-family:'Roboto',Arial,Helvetica,sans-serif;color:#34495E;max-width:480px;min-width:150px" method="post">
    ...
    <div class="title">
        ...
        <div class="element-input">
            ...
            <div class="item-cont">
                <input class="large" type="text" name="titulo" required="required" placeholder="Titulo" value="<?=$titulo ?>" />
        ...
        <div class="element-textarea">
            ...
            <div class="item-cont">
                <textarea class="medium" name="descripcion" cols="20" rows="5" required="required" placeholder="Descripción" ><?=$descripcion ?></textarea>
                <span class="icon-place"></span>
            </div>
        </div>
        <div class="element-file" title="Imagen">
            ...
            <div class="item-cont">
                <label class="large">
                    ...
                    <input type="file" class="file_input" name="imagen"/>
        ...
        <div class="element-file" title="Pdf">
            ...
            <div class="item-cont">
                <label class="large">
                    ...
                    <input type="file" class="file_input" name="pdf"/>
                    <div class="file_text">No file selected</div>
                    <span class="icon-place"></span>
                </label>
            </div>
