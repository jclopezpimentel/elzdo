            ...
            <div>
                ...
                ?>
                    ...
                    <div id="adminSD">
                        ...
                        <form name="form1" enctype="multipart/form-data" action="editarAudio" class="formoid-solid-blue" onsubmit="return validateForm()" style="background-color:#ffffff;font-size:14px;font-family:'Roboto',Arial,Helvetica,sans-serif;color:#12345e;max-width:480px;min-width:150px" method="post">
                <div class="title"><h2>AudioCuentos</h2></div>
                <input type="hidden" name="id" value="<?=$id?>" />
                <div class="element-input" title="Titulo"><label class="title"><span class="required">*</span></label><div class="item-cont"><input class="large" type="text" name="titulo" id="titulo" required="required" placeholder="Titulo" value="<?=$titulo?>" /><span class="icon-place"></span></div></div>
                ...
                <div class="element-file" ><label class="title"><span class="required">*</span></label><div class="item-cont"><label class="large" ><div class="button">Seleccionar Audio</div><input type="file" class="file_input" name="file"/><div class="file_text">No file selected</div><span class="icon-place"></span></label></div></div>
