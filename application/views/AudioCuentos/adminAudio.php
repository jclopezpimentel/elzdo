        ...
        <div class="container">
            ...
            <div>
                ...
                ?>
                    ...
                    <link rel="stylesheet" href="https://formoid.net/forms/a7/107626/formoid-solid-blue.css" type="text/css">
                    
                    <div id="adminSD">

                    
                        <form name="form1" enctype="multipart/form-data" action="uploadAudio" class="formoid-solid-blue" onsubmit="return validateForm()" style="background-color:#ffffff;font-size:14px;font-family:'Roboto',Arial,Helvetica,sans-serif;color:#12345e;max-width:480px;min-width:150px" method="post">
                <div class="title"><h2>Subir AudioCuentos</h2></div>
                <div class="element-input" title="Titulo"><label class="title"><span class="required">*</span></label><div class="item-cont"><input class="large" type="text" name="titulo" id="titulo" required="required" placeholder="Titulo"/><span class="icon-place"></span></div></div>
                <div class="element-select" title="Selecciona grado escolar"><label class="title"><span class="required">*</span></label><div class="item-cont"><div class="large"><span>
                    <select id="grado" name="gradoEscolar" required="required" onchange="addG(this.value)" onchange="addG(this.value)">
                ...
                <div class="element-file" ><label class="title"><span class="required">*</span></label><div class="item-cont"><label class="large" ><div class="button">Seleccionar Audio</div><input type="file" class="file_input" name="file" required="required"/><div class="file_text">No file selected</div><span class="icon-place"></span></label></div></div>
